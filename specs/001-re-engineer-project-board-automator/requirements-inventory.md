...
- Repository-wide searches (`getRecentItems`) respect `technical.min_rate_limit_remaining` (default 200) before issuing GraphQL queries, logging a skip when the guard fails.
